...
- `CardOracle.sol` is a pushed price feed per card design, standing in for TCG market data.
...
- The oracle is owner-pushed. Production needs a real feed with staleness checks.
